...
def test_instantiate_helper(debug=False):
    for (
        ...
        (
            ...
            {},
            {
                "Q": Formula.parse("Ax[(Greek(x)->Human(x))]"),
                "R": Formula.parse("(Greek(_)->Mortal(_))"),
            },
        ...
        (
            ...
            {},
            {
                "Q": Formula.parse("Ax[(Greek(x)->Human(x))]"),
                "R": Formula.parse(
                    "(Ax[(Greek(x)->Human(x))]->(Greek(_)->Mortal(_)))"
                ),
            },
            "(Ax[(Ax[(Greek(x)->Human(x))]->(Ax[(Greek(x)->Human(x))]->(Greek(x)->Mortal(x))))]->(Ax[(Greek(x)->Human(x))]->Ax[(Ax[(Greek(x)->Human(x))]->(Greek(x)->Mortal(x)))]))",
        ),
    ]:
...
def test_instantiate(debug=False):
    for formula, templates, instantiation_map, instance in [
        ...
        if instance is None:
            ...
            assert str(result) == instance, f"result: {result}"
