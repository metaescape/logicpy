...
def _test_is_closed(
    ...
    for six_element_group_primitives in [
        ...
        _test_closures(
            (
                six_element_group_primitives - {Formula.parse("Plus(3,0,3)")}
            ).union({Formula.parse("~Plus(3,0,3)"), ZERO_AXIOM}),
            True,
            False,
            True,
        )
...
def test_combine_contradictions(debug=False):
    ...
    combined = combine_contradictions(
        proof_from_affirmation, proof_from_negation
    )
...
def test_universal_closure_step(debug=False):
    if debug:
        print(
            "Testing universal_closure_step on zero axiom with six "
            "elements..."
        )
    ...
    if debug:
        print(
            "Testing universal_closure_step on negation axiom with six "
            "elements..."
        )
    augmented = universal_closure_step(
    ...
    if debug:
        print(
            "Testing universal_closure_step on group axioms with six "
            "elements..."
        )
    augmented = universal_closure_step(
        frozenset(
